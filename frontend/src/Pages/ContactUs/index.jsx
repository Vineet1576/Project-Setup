...
export default function ContactUs() {
  ...
  const handleTwitter = (value) => (value ? `https://twitter.com/${String(value).trim().replace(/^@/, '')}` : null);

  const socialChannels = [
    { label: 'Facebook', value: social.facebook || '', icon: <FaFacebookF />, href: toUrl(social.facebook) },
    { label: 'X (Twitter)', value: social.twitter || '', icon: <FaTwitter />, href: handleTwitter(social.twitter) },
    { label: 'Instagram', value: social.instagram || '', icon: <FaInstagram />, href: toUrl(social.instagram) },
    { label: 'LinkedIn', value: social.linkedin || '', icon: <FaLinkedinIn />, href: toUrl(social.linkedin) },
    { label: 'YouTube', value: social.youtube || '', icon: <FaYoutube />, href: toUrl(social.youtube) },
          ...
          <nav className="flex items-center gap-2 text-[13px] text-white/40">
            ...
            <div className="mt-6 max-w-[640px]">
              <span className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-400/10 px-4 py-1.5 text-[12px] font-semibold text-blue-300">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round">
          ...
          <div className="lg:col-span-2" style={{ width: 'calc(100% + 10px)', marginLeft: '-5px' }}>
            ...
            <div className="mt-6 rounded-xl border border-white/10 bg-[#131318] p-5">
              <p className="text-[13px] leading-relaxed text-white/50">
                ...
                <Link to="/help" className="text-blue-300 hover:text-blue-200 transition-colors">Help Center</Link>{' '}
            ...
            {sent ? (
              ...
              <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#14141c] to-[#101018] p-6 sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[11px] font-bold tracking-widest text-[#3b82f6]">FEEDBACK FORM</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="name" className="block text-[13px] font-medium text-white/70 mb-2">Your name</label>
                  ...
                  <div>
                    <label htmlFor="email" className="block text-[13px] font-medium text-white/70 mb-2">Email address</label>
                ...
                <div>
                  <label className="block text-[13px] font-medium text-white/70 mb-2">Topic</label>
                ...
                <div>
                  <label htmlFor="message" className="block text-[13px] font-medium text-white/70 mb-2">Message</label>
                  <textarea
                    id="message"
                    name="message"
                    required
