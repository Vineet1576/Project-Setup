                  ...
                  <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
                    {items.map((n) => (
                      <li
                        ...
                        style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '16px 20px', borderBottom: '1px solid var(--hairline)', background: n.read ? 'transparent' : 'rgba(59,130,246,0.08)', cursor: 'pointer', transition: 'background 0.18s ease' }}
                      >
