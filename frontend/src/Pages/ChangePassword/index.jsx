    ...
    <AuthLayout>
      <div className="w-full">
        ...
        <form onSubmit={handleSubmit} noValidate className="mt-4">
          <div className="mb-4">
            <label className="text-[14px] font-[500] mb-1 text-white/80">
          ...
          <div className="flex justify-center mt-5">
            <button
              ...
              className="bg-transparent border-none text-[#3b82f6] font-semibold text-[14px] cursor-pointer hover:underline"
            >
              Back to Profile
            </button>
          </div>
